		...
		<section>
            <article>
				...
				<form name="FormInscription" method="post" action="inscription.php">
					...
					<input type="date" name="aa" placeholder="aaaa" maxlength="4" size="5"><input type="date" name="mm" placeholder="mm" maxlength="2" size="2"><input type="date" name="jj" placeholder="jj" maxlength="2" size="2"><br/>

			    ...
			    if( $connection )
			    {
				    ...
				    if( $resultat )
				    {
					    ...
					    if( mysqli_num_rows($resultat) != 0 )
					    {
							...
							$_SESSION['sexe']  			= $tableau['sexe'];							
							$_SESSION['datenaissance']  = $tableau['datenaissance'];
							$_SESSION['pays']  			= $tableau['pays'];
							$_SESSION['dateinscription']= $tableau['dateinscription'];
							$_SESSION['email']  		= $tableau['email'];
							$_SESSION['login'] 			= $tableau['login'];
							$_SESSION['mdp']  			= $tableau['mdp'];
